...
Base.sizehint!(d::VectorDict, newsize) = (sizehint!(d.keys, newsize); sizehint!(d.values, newsize); return d)
...
Base.sizehint!(d::SortedVectorDict, newsize) =
    (sizehint!(d.keys, newsize); sizehint!(d.values, newsize); return d)
